...
(function () {
    ...
    var _fnCordovaCommon = function (CORDOVA_JS_BUILD_LABEL) {
        ...
        define('cordova/plugin_list', function (require, exports, module) {
            ...
            //ble
            arrPluginList = arrPluginList.concat(arrBLE);
            objPluginMeta["cordova-plugin-ble-central"] = "1.1.4";
            
            //bluetooth serial
            arrPluginList = arrPluginList.concat(arrBluetoothSerial);
            objPluginMeta["cordova-plugin-bluetooth-serial"] = "0.4.7";
